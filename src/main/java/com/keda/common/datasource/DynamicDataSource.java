package com.keda.common.datasource;

import com.keda.common.dbmgr.ProjectDBMgr;
...
public class DynamicDataSource extends DataSource {
    ...
    private DataSource initDDS(String projectCode) throws IllegalArgumentException, IllegalAccessException {
        ...
        String ip=ProjectDBMgr.instance().getDBIP(projectCode);
        String name=ProjectDBMgr.instance().getDBName(projectCode);
